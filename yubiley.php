...
<html>
<head>
	<title>Фото юбилея</title>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="description" content="Фотографии свадьба" />
	<meta name="keywords" content="фото юбилей, фотографии юбилея" />
			...
			<tr>
				...
				<td id = "film_body">
					...
					<?php for ($i = 0; $i < count($files); $i++) { ?>
						<a href="<?=$dir."/".$files[$i]?>" data-lightbox="roadtrip" class="img_gallery" title="Фото юбилея">
